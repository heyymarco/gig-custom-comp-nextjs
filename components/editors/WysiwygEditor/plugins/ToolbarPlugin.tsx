...
export interface ToolbarPluginProps<TElement extends Element = HTMLElement>
    extends
        ...
        Omit<BasicProps<TElement>,
            // children:
            |'children' // we redefined the children
        >,
        ...
        >
{
    ...
    // children:
    children ?: React.ReactNode | ((children: React.ReactNode[], basicVariantProps: BasicVariantProps) => React.ReactNode)
}
const ToolbarPlugin = <TElement extends Element = HTMLElement>(props: ToolbarPluginProps<TElement>): JSX.Element|null => {
    ...
    // children:
    const defaultChildren : React.ReactNode[] = React.Children.toArray([ // automatically create key(s)
        ...
        >
            {React.cloneElement<BasicProps<TElement>>(component,
                ...
                : (typeof(children) !== 'function')
                    ? children
                    : children(defaultChildren, basicVariantProps),
            )}
        </AccessibilityProvider>
    );
};
